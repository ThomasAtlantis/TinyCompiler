...
int main() {
    ...
    grammar.add("A3") >> "A8 qua_sav_func_name qua_new_synbl ( A9 ) { B0 qua_return }";
    grammar.add("A9") >> "B1 B2" | "null";
    grammar.add("B2") >> ", B1 B2" | "null";
    grammar.add("B1") >> "B3 B4 qua_declare";
    grammar.add("B4") >> "A8 qua_declare_id B5" | "& A8 qua_declare_id";
    ...
    grammar.add("D8") >> "C2";
    grammar.add("E0") >> "return";
    grammar.add("B3") >> "int qua_int" | "float qua_float" | "bool qua_bool" | "char qua_char";
    grammar.add("C2") >> "E1";
    grammar.add("E1") >> "E2 E3";
    grammar.add("E3") >> "> E2 qua>" | ">= E2 qua>=" | "< E2 qua<" | "<= E2 qua<=";
    grammar.add("E3") >> "== E2 qua==" | "!= E2 qua!=" | "null";
    grammar.add("E2") >> "E4";
    grammar.add("E4") >> "E5";
    grammar.add("E5") >> "E6 E7";
    grammar.add("E7") >> "+ E6 qua+ E7" | "- E6 qua- E7" | "null";
    grammar.add("E6") >> "E8 E9";
    grammar.add("E9") >> "* E8 qua* E9" | "/ E8 qua/ E9" | "null";
    grammar.add("E8") >> "F0";
    grammar.add("F0") >> "F1" | "! F1" | "- F1 qua.";
    grammar.add("F1") >> "A8 quap qua_check_def_e F2" | "F3 quap" | "( C2 )";
    grammar.add("F2") >> "D6" | ". A8 quap qua_member";
